    ...
    >
      ...
      <div className="flex flex-row">
        ...
        <main className="flex-grow px-4 py-4 overflow-y-auto bg-white border-t border-gray-400">
          <div className="mx-auto bg-gray-100 border border-gray-400 p-4">
            {/* Response Output */}
            {loading && (
              <div className="bg-gray-100 flex flex-col w-full">
                ...
                <div className="max-w-full h-6 bg-red-700 border-2 border-red-500 relative overflow-hidden">
            ...
            >
              <textarea
                ...
                className="flex-grow border border-gray-400 p-2 text-sm bg-white text-black border-transparent focus:border-gray-600 focus:outline-none focus:ring-0"
                style={{ fontFamily: "Arial, sans-serif" }}
              />
